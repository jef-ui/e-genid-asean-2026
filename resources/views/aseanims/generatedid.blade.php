    ...
    <body>
        ...
        <div class="dashboard">
            ...
            <div class="enroll-id-dashboard">
                <a href="/asean-2026/dashboard/enrolled-stgepr-e-ids/e-id-enrollment-form"><button
                        class="createButton">Enroll STGEPR e-ID</button></a>
            ...
            <div class="main-container">
             ...
             ">
                                        ...
                                        <td><a href="{{ route('stgepr.show', $r->id) }}"><img
                                        ...
                                        <td>
                                            <form action="{{ route('stgepr.delete', $r->id) }}" method="POST"
            ...
            <button onclick="window.open('{{ route('stgepr.certificates.pdf') }}')" class="createButton"
                style="background:#0a7cff;">
                Download Certificates (PDF)
            </button>

            <button onclick="window.open('{{ route('stgepr.print') }}', '_blank')" class="createButton"
                style="background:#0a7cff;">
                Print Masterlist
            </button>
        </div>
